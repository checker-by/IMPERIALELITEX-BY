                ...
                function() {
                  Array.prototype.randomElement = function () {
                   ...
                   var proxy = MyArray.randomElement();
                           $.ajax({
                        url: 'g2api.php?lista=' + value + '&proxy=' + proxy,
                        async: true,
...
<div class="card col-sm-12">
  <span class="badge badge-info"><h4>Gate 2 - CVV/CCN</h4></span>
  <div class="card-body">
<div class="md-form">
  <p style="color:red; size:30px; font-weight: bold;">CC VALIDATOR [1 check only]</p>
	<div class="col-md-12">
...
<br>
<textarea type="text" style="text-align: center;" id="lista" maxlength="28" class="md-textarea form-control" rows="50" placeholder="FORMAT: xxxxxxxxxxxxxxxx|mm|year|cvv" ></textarea>
<br>
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="copyright">
            ...
            <a href="http://t.me/teamxcode"> XCODE</a>
          </div>
        </div>
      </footer>
    </div>
